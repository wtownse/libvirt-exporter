...
var (
	...
	libvirtDomainInfoMetaDesc = prometheus.NewDesc(
		...
		"Domain metadata",
		[]string{"domain", "title", "uuid", "instance_name", "flavor", "user_name", "user_uuid", "project_name", "project_uuid", "root_type", "root_uuid"},
		nil)
	...
	libvirtDomainMetaBlockDesc = prometheus.NewDesc(
		...
		[]string{"domain", "title", "target_device", "source_file", "serial", "bus", "disk_type", "driver_type", "cache", "discard"},
		nil)
	libvirtDomainBlockRdBytesDesc = prometheus.NewDesc(
		...
		[]string{"domain", "title", "target_device"},
		nil)
	...
	libvirtDomainMetaInterfacesDesc = prometheus.NewDesc(
		...
		[]string{"domain", "title", "source_bridge", "target_device", "virtual_interface"},
		nil)
